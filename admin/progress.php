        ...
        <table>
            ...
            <tbody>
                ...
                while($data = mysqli_fetch_assoc($query)){
                    ...
                    $badgeBg = "rgba(212, 175, 55, 0.15)"; $badgeColor = "#b89322";
                    if($statusProg == 'selesai' || $data['persentase'] == 100) { $badgeBg = "rgba(16, 185, 129, 0.15)"; $badgeColor = "#059669"; }
                    elseif($statusProg == 'berjalan') { $badgeBg = "rgba(14, 165, 233, 0.15)"; $badgeColor = "#0284c7"; }
                ?>
                <tr style="border-bottom: 1px solid var(--border-color); transition: background 0.2s;" onmouseover="this.style.background='#fdfbf7'" onmouseout="this.style.background='transparent'">
                    ...
                    <td style="padding: 16px 20px;">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <span style="font-weight: 700; color: #1e293b; min-width: 40px; text-align: right;"><?= $data['persentase']; ?>%</span>
                    ...
                    <td style="padding: 16px 20px; color: #64748b; font-weight: 500;"><?= date('d M Y', strtotime($data['tanggal_progress'])); ?></td>
                    ...
                    <td style="padding: 16px 20px; text-align: center;">
                        <div style="display: flex; gap: 12px; justify-content: center; align-items: center;">
                            <a href="edit_progress.php?id=<?= $data['id_progress']; ?>" style="text-decoration: none; color: var(--primary-gold); font-weight: 600; font-size: 13px;">Edit</a>
                            <span style="color: #cbd5e1; font-size: 12px;">|</span>
                            <a href="hapus_progress.php?id=<?= $data['id_progress']; ?>" style="text-decoration: none; color: #f43f5e; font-weight: 600; font-size: 13px;" onclick="return confirm('Yakin ingin menghapus rekaman progress ini?')">Hapus</a>
                        </div>
                    </td>
                </tr>
                <?php } ?>
