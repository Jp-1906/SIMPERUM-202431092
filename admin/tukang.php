...
<head>
    ...
    table {
        ...
        text-align: left; 
        font-size: 14px;
        min-width: 800px; /* Batas minimal lebar tabel agar kolom tidak bertumpukan di HP */
    }

    @media (max-width: 768px) {
        .content {
            padding: 85px 16px 25px 16px; /* Memberikan ruang jarak atas aman dari mobile topbar header */
        }
        ...
        <table>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border-color); transition: background 0.2s;" onmouseover="this.style.background='#fdfbf7'" onmouseout="this.style.background='transparent'">
                    ...
                    <td style="padding: 16px 20px; color: #64748b; font-weight: 500; font-family: inherit;"><?= $data['no_hp']; ?></td>
                    
                    <td style="padding: 16px 20px; text-align: center;">
                        <div style="display: flex; gap: 12px; justify-content: center; align-items: center;">
                            <a href="edit_tukang.php?id=<?= $data['id_tukang']; ?>" style="text-decoration: none; color: var(--primary-gold); font-weight: 600; font-size: 13px; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
                                Edit
                            </a>
                            <span style="color: #cbd5e1; font-size: 12px;">|</span>
                            <a href="hapus_tukang.php?id=<?= $data['id_tukang']; ?>" style="text-decoration: none; color: #f43f5e; font-weight: 600; font-size: 13px; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'" onclick="return confirm('Yakin ingin menghapus data tukang <?= $data['nama_tukang']; ?>?')">
                                Hapus
                            </a>
                        </div>
                    </td>
