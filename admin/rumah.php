...
<head>
    ...
    table {
        ...
        text-align: left; 
        font-size: 14px;
        min-width: 750px; /* Batas minimal lebar tabel agar kolom tidak menumpuk di HP */
    }

    @media (max-width: 768px) {
        .content {
            padding: 85px 16px 25px 16px; /* Memberikan ruang agar tidak tertabrak header topbar mobile */
        }
        ...
        <table>
            <thead>
                <tr style="background: #fafafa; border-bottom: 2px solid var(--border-color);">
                    ...
                    <th style="padding: 16px 20px; color: #64748b; font-weight: 600; width: 120px;">Foto Unit</th>
            ...
            <tbody>
                ...
                while($data = mysqli_fetch_assoc($query)){
                    ...
                    // Pewarnaan soft badge dinamis diselaraskan dengan modul denah
                ...
                <tr style="border-bottom: 1px solid var(--border-color); transition: background 0.2s;" onmouseover="this.style.background='#fdfbf7'" onmouseout="this.style.background='transparent'">
                    ...
                    <td style="padding: 16px 20px;">
                        <div style="width: 70px; height: 50px; border-radius: var(--radius-sm); overflow: hidden; background: #f1f5f9; border: 1px solid var(--border-color);">
                            <?php 
                    ...
                    <td style="padding: 16px 20px; font-weight: 600; color: var(--primary-gold);">
                    ...
                    <td style="padding: 16px 20px; text-align: center;">
                        <div style="display: flex; gap: 12px; justify-content: center; align-items: center;">
                            <a href="edit_rumah.php?id=<?= $data['id_rumah']; ?>" style="text-decoration: none; color: var(--primary-gold); font-weight: 600; font-size: 13px; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
                                Edit
                            </a>
                            <span style="color: #cbd5e1; font-size: 12px;">|</span>
                            <a href="hapus_rumah.php?id=<?= $data['id_rumah']; ?>" style="text-decoration: none; color: #f43f5e; font-weight: 600; font-size: 13px; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'" onclick="return confirm('Yakin ingin menghapus unit <?= $data['kode_rumah']; ?>?')">
                                Hapus
                            </a>
                        </div>
                    </td>
